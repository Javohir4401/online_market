                    ...
                    <div class="bb-category-block owl-carousel ml-[-150px] w-[calc(100%+150px)] pt-[30px] pl-[30px] bg-[#fff] rounded-tl-[30px] relative max-[991px]:ml-[0] max-[991px]:w-full max-[991px]:p-[0]">
                        ...
                        <div class="bb-category-box p-[30px] rounded-[20px] flex flex-col items-center text-center max-[1399px]:p-[20px] category-items-1 bg-[#fef1f1]" data-aos="flip-left" data-aos-duration="1000" data-aos-delay="200">
                            <div class="category-image mb-[12px]">
                                <img src="{{ \Illuminate\Support\Facades\Storage::url($category->images[0]->path) }}" alt="category" class="w-[50px] h-[50px] max-[1399px]:h-[65px] max-[1399px]:w-[65px] max-[1199px]:h-[50px] max-[1199px]:w-[50px]">
                            </div>
                ...
                <div class="blog-2-slider owl-carousel">
                    @foreach($latestPosts as $latestPost)
                        <div class="blog-2-card relative overflow-hidden rounded-[30px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                            <div class="blog-img">
                                <img src="{{ \Illuminate\Support\Facades\Storage::url($latestPost->image) }}" alt="blog-7" class="transition-all duration-[0.3s] ease-in-out w-full block">
                            </div>
                            <div class="blog-contact transition-all duration-[0.3s] ease-in-out m-[5px] p-[15px] absolute bottom-[0] right-[0] left-[0] bg-[#ffffffe6] rounded-[30px]">
                                <span class="font-Poppins font-normal text-[13px] leading-[26px] tracking-[0.02rem] text-[#686e7d]">{{ $latestPost->updated_at->diffForHumans() }} - {{ $latestPost->postCategory->name }}</span>
                                <h4 class="text-[16px] leading-[1.2]"><a href="blog-detail-left-sidebar.html" class="font-Poppins tracking-[0.03rem] text-[16px] font-medium leading-[1.3] text-[#3d4750]">{{ $latestPost->title }}</a></h4>
                            </div>
                        </div>
                    @endforeach
                </div>
